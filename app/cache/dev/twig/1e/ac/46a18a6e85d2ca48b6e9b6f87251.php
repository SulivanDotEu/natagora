...
/* WalvaNatagoraBundle:Formation:show.html.twig */
class __TwigTemplate_1eac46a18a6e85d2ca48b6e9b6f87251 extends Twig_Template
{
    ...
    <li>
        <form action=\"";
        // line 35
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("formation_delete", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id"))), "html", null, true);
        echo "\" method=\"post\">
...
";
    ...
    {
        return "WalvaNatagoraBundle:Formation:show.html.twig";
    }
